...
The full latent atlas and the 3D manifolds of every composite live in the
[interactive explorer](/bae). Browse the UMAP of all composites, drill into
individual latents, and rotate the manifolds for any of them.
